...
namespace ECS
{
	...
	*/
	...
	private:
		...
		Checker checker; // each system will have an array about require and exclude component
	...
	public:
		...
		ISystem(Checker _checker) : checker(_checker) { }
	...
	**/
	...
	public:
		...
		System() :ISystem{ MakeChecker <Requires,Exclude>() }
		{
