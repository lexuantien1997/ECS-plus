...
namespace ECS
{
	...
	*/
		...
		// ==================================================
		// Call later
		// 2 class này được gọi khi chúng ta tạo các System:
		template <class ... Args>
		...
		struct Checker
		{
			...
			*/
			bool checkComponentsSystem(Entity* entity)
			{
		...
		*/
		...
		template<class RequireList>
		ComponentTypeList addRequire()
		{
			return types(RequireList{});	
		}

		template<class ExcludeList>
		ComponentTypeList addExclude()
		{
			return types(ExcludeList{});
		}
	}
